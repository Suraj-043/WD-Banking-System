...
<head>
  ...
  <title>JMC Bank</title>
  <link rel="shortcut icon" href="images/JMC Logo1.png" type="image/x-icon">
...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark sticky-top">
    <div class="container-fluid">
      <a class="navbar-brand" href="index.php">
        ...
        <img src="images/JMC Logo1.png" alt="logo" style="width:65px;">
      </a>
  ...
  <section class="topContent">
    <div class="mainHeading">
      <div>
        <span class="main-content">Basic Banking Services</span>
      </div>
      <div style="margin-top: 12px;">
        <span class="sub-content">Basic banking services include a payment account with basic features, an instrument for using the account (e.g. a debit card) & the execution of payment transactions.</span>
      </div>
      <a href="#services" class="btn btn-secondary mt-3">Get Started</a>
    </div>
    <div class="topContentImg">
      <img src="images/Main.jpeg" alt="Banking">
    </div>
  </section>
  <!-- End Home -->
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-6 mx-auto">
          <img class=" mt-3 " style="width:400px;" src="images/AboutImage.png" alt="JMC Bank">
        </div>
        <div class="col-md-6 mx-auto mt-4">
          <div>
            <span class="text">JMC Bank</span>
          </div>
          <div class="mt-2">
          ...
          <a href="#services" class="btn btn-secondary mt-3">Learn More</a>
        </div>
      </div>
    </div>
  </section>
      ...
      <div class="row">
        <div class="card col-md-3 mx-auto" style="width: 18rem;">
          ...
          <div class="card-body">
            ...
            <a href="transfermoney.php" class="btn btn-outline-primary">View Customers</a>
          </div>
        </div>
        ...
        <div class="card col-md-3 mx-auto" style="width: 18rem;">
          ...
          <div class="card-body">
            ...
            <a href="transactionhistory.php" class="btn btn-outline-primary">View Transactions</a>
          </div>
        </div>
        ...
        <div class="card col-md-3 mx-auto" style="width: 18rem;">
          ...
          <div class="card-body">
            ...
            <a href="transfermoney.php" class="btn btn-outline-primary">Transfer Money</a>
          </div>
        </div>
      </div>
    </div>
